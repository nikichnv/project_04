...
public class TestAccordion {
    ...
    public TestAccordion(int numberElement, String expectedHeaderText, String expectedItemText) {
        this.numberElement = numberElement;
        this.expectedHeaderText = expectedHeaderText;
        this.expectedAnswerText = expectedItemText;
    }
    ...
    @Test
    public void checAcordionIsCorrect() {
